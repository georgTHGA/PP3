...
<details>
    ...
    The # symbol allows you to select different heading levels. The more #, the lower the level.
</details>
<details>
    <summary>How do you mark italic or bold font?</summary>
    <code>
    With a * the text becomes italic, with two ** it becomes thick and with 3 *** it becomes both.
    </code>
</details>
<details>
    <summary>Which different ways are there to generate listings and tables?</summary>
    <code>
    You can create tables using "-" and "|" symbols.
    </code>
</details>
...
<details>
    ...
    pdflatex -jobname=neuer-Name alter-Name
</details>
